    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ route('admin.permission.update') }}" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group @if($errors->has('permission_name')) has-error @endif">
                                    ...
                                    <input type="text" id="permission_name" name="permission_name" value="{{ old('permission_name', $permission->permission_name) }}" class="form-control" placeholder="请输入权限名称" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group @if($errors->has('route')) has-error @endif">
                                    <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                                    <input type="text" id="route" name="route" value="{{ old('route', $permission->route) }}" class="form-control" placeholder="请输入路由" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
