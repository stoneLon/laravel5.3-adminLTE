    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ route('admin.adminUser.update') }}" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group @if($errors->has('username')) has-error @endif">
                                    ...
                                    <input type="text" id="username" name="username" value="{{ old('username', $admin_user->username) }}" class="form-control" placeholder="Input Username" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
